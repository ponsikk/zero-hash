 ...
 * 
 * <p>BLAKE3 is a cryptographic hash function that is fast and secure.
...
public final class Blake3 {
     ...
     * 
     * <p>This method avoids copying data from native memory to Java heap,
     ...
     * 
     * <p>Use this for hashing large files or data streams.
    ...
    public static final class Hasher implements AutoCloseable {
         ...
         * @return hash bytes
         */
        public byte[] finalize(int outputLength) {
            if (handle == null) {
                throw new IllegalStateException("Hasher is closed");
            }
            if (outputLength <= 0) {
