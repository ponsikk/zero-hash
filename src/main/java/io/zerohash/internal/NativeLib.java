 ...
 * 
 * <p>
 * This class handles loading the native library and provides
...
public final class NativeLib {
    ...
    public static final MethodHandle BLAKE3_HASH_PARALLEL;
    ...
    static {
        ...
        if (LOADED) {
            ...
            // blake3_hash_keyed(key: *const u8, data: *const u8, len: usize, out: *mut u8)
            // -> i32
            ...
            // blake3_hash_parallel(data, len, out) -> i32 (Rayon parallel)
            BLAKE3_HASH_PARALLEL = downcall("blake3_hash_parallel",
                    FunctionDescriptor.of(
                            ValueLayout.JAVA_INT,
                            ValueLayout.ADDRESS,
